...
<template>
    <!-- Initial Loader -->
    <div v-if="isInitializing" class="fixed inset-0 z-50 flex items-center justify-center
    ...
    <div v-else class="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
        ...
        <header class="sticky top-0 z-20 bg-white dark:bg-gray-900
            ...
            <div class="px-4 pt-4 pb-0">
                ...
                <!-- Navigation -->
                <nav class="mt-4 flex gap-2 overflow-x-auto scrollbar-none pb-2" aria-label="Primary navigation">
